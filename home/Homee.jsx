...
import LOGO3 from './pictures/image00010.jpg'
       ...
       <div className='highlights'>
            <div className='row'>
                <div className='column'>
                    <img src={LOGO7} alt='' />
                    <h5>special signature made in the house</h5>
                    <p>This dish embodies the essence of Afrikan cuisine, showcasing a perfect fusion of flavors that will tantalize your taste buds.</p>
                </div>

                <div className='column'>
                    <img src={LOGO8} alt='' />
                    <h5>Life's better poolside</h5>
                    <p>journey into clarity, tranquility, and the pure embrace of water's pristine beauty </p>
                </div>

                <div className='column'>
                    <img src={LOGO3} alt='' />
                    <h5>A small step for prawns, a giant leap for prawn-kind</h5>
